...
public class MemberController {
    ...
    public String memberModify(@RequestBody @Valid ModifyRequestDto modifyRequestDto, @PathVariable("member_id") Long member_id){
...
//    }
    ...
    @PostMapping(value = "/api/member/dump/{member_id}", consumes = MediaType.APPLICATION_JSON_VALUE)
